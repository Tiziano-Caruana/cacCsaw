...
def index():
    ...
    if visited:
        ...
        if qr_id and qr_id != "":
            ...
            response = make_response(render_template("index_eng.html", global_count=global_count, qr_count=qr_count))
        else:
    ...
    return render_template("index_eng.html", global_count=global_count, qr_count=qr_count)
